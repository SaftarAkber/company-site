    ...
    <>
        ...
        <FadeIn>
          <div className="flex items-end justify-between mb-10 flex-wrap gap-4">
            <div>
              ...
              <h2 className="font-display text-2xl sm:text-3xl">Son layihələrimiz</h2>
            </div>
            <Link href="/projects" className="text-sm text-graphite/60 hover:text-accent transition-colors">
              Hamısına bax →
            </Link>
          </div>
        </FadeIn>
      ...
      <section className="bg-line-light/30 border-t border-line-light">
        <div className="max-w-6xl mx-auto px-6 py-20 grid grid-cols-1 sm:grid-cols-3 gap-10">
          {[
            { title: "Keyfiyyət", desc: "Hər detala diqqət yetiririk, tələsik iş görmürük." },
            { title: "Şəffaflıq", desc: "Prosesin hər addımında müştəri ilə açıq ünsiyyət." },
            { title: "Sürət", desc: "Vaxtında təhvil, lazımsız gecikmə olmadan." },
          ].map((item, i) => (
